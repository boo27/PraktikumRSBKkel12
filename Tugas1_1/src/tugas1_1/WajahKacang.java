 ...
 * @author Dhyn
 */
public class WajahKacang extends javax.swing.JFrame {

    /**
     * Creates new form WajahKacang
     */
    public WajahKacang() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RSBK");

        jButton3.setText("Indentitas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WajahKacang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WajahKacang().setVisible(true);
            }
        });
    }
